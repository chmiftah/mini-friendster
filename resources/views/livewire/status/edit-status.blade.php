<div class="border p-6 border-gray-100 rounded-lg overflow-hidden mb-4">
    ...
    {{-- <div class="flex">
        <div class="w-full md:w-1/2">
            <div class="border border-gray-100 mb-5 rounded-lg overflow-hidden mb-4">
                ...
                <form wire:submit.prevent="update">
                    <div class="p-4 bg-blue-50">
                            ...
                            <textarea name="" wire:model="body"  class=" bg-blue-50 form-textarea w-full resize-none border-0 focus:shadow-none p-0 focus:ring-0 " placeholder=" What's in your mind.?">{{ old('body') ?? $status->body }}</textarea>
                        @error('body')
